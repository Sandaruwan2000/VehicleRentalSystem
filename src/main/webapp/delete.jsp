...
<header class="header">
    ...
    <form  class="datau"action="delete" method="post">
...
<tr>
<td>Mobile :</td>
<td><input type="tel" id="mobile" name="mobile" placeholder="0123456789" pattern="[0-9]{10}"  value="<%= mobile %>" readonly></td>
</tr>

<tr>

<td><button id="submit" name="submit">Delete</button></td>
</tr>
